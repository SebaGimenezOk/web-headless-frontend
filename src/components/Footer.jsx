...
export default function Footer() {
  ...
  return (
    <footer className="w-full bg-neutral-900 text-white pb-20">
      <div className="max-w-7xl max-h-96 mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-3 gap-10">
      ...
      <div className="border-t border-neutral-800">
        <div className="max-w-7xl mx-auto px-6 py-4 flex flex-col md:flex-row justify-between items-center text-xs text-neutral-400 gap-2">
          <span>
