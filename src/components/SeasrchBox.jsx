  ...
  useEffect(() => {
    ...
    const timer = setTimeout(async () => {
      try {
        ...
        // Consultamos al CPT 'podcast' con _embed activado
        ...
        const formattedResults = posts.map((post) => {
          // Limpiamos los títulos de tags HTML y caracteres codificados de WP
          ...
          // Extraemos la categoría o temporada si viene en los metadatos incrustados
